...
@WebServlet("/lastTimeGet2")
public class lastTimeGet2 extends HttpServlet {
...
//                    String lastTimeValue = URLDecoder.decode (cookie.getValue (), "utf-8");
                    byte[] decode = Base64.getDecoder ().decode (cookie.getValue ().getBytes ("utf-8"));
                    String lastTimeValue = new String (decode);
...
//                    strDate = URLEncoder.encode (strDate, "utf-8");
                    strDate = Base64.getEncoder ().encodeToString (strDate.getBytes ("utf-8"));
